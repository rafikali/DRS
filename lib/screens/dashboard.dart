...
import '../repo/models/carddata.dart';
import '../repo/models/daily_update.dart';
import '../repo/services/daily_update_services.dart';
import '../repo/services/dashboard_services.dart';
import 'my_missing_checkout.dart';
            ...
            Grid(
              ...
              children: [
                CardView(
                  ...
                  color: dashboardCardData?.myMissingCheckoutCount.toString() ==
                          '0'
                      ? Colors.green
                      : Colors.red,
                            ...
                            children: [
                              ListTile(
                                ...
                                title: Column(
                                  children: [
                                    Text(
                                        recentUpdates2?.data![0].title ?? 'N/A',
